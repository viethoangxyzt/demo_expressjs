...
(function(e) {
    ...
    "use strict";
    var i = "tocify", o = "tocify-focus", n = "tocify-hover", a = "tocify-hide", l = "tocify-header", h = "." + l,
        r = "tocify-subheader", d = "." + r, c = "tocify-item", f = "." + c, u = "tocify-extend-page", p = "." + u;
    e.widget("toc.tocify", {
        version: "1.9.0",
        options: {
            context: "body",
        ...
        _generateToc: function() {
            var t, s, o = this, n = o.options.ignoreSelector;
        ...
        _nestElements: function(t, s) {
            ...
            return i = e.grep(this.items, function(e) {
                ...
                "class": c,
                "data-unique": n
            }).append(e("<a/>", { text: t.text() })), t.before(e("<div/>", { name: n, "data-unique": n })), o
        },
        _generateHashValue: function(e, t, s) {
            var i = "", o = this.options.hashGenerator;
            if ("pretty" === o) {
        ...
        _appendSubheaders: function(t, s) {
            var i = e(this).index(t.options.selectors), o = e(t.options.selectors).eq(i - 1),
                n = +e(this).prop("tagName").charAt(1), a = +o.prop("tagName").charAt(1);
        ...
        _setEventHandlers: function() {
            ...
            this.element.on("click.tocify", "li", function() {
                ...
                e("html, body").promise().done(function() {
                    var o, n, a, l, h = e(t).scrollTop(), r = e(t).height(), d = e(s).height(),
        ...
        _scrollTo: function(t) {
            var s = this, i = s.options.smoothScroll || 0, o = s.options.scrollTo,
